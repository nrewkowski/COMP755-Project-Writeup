...
Object detection xxx

Object detection with eye tracking xxx
...
\subsection{Image defocusing}

Third-level headings should be in 10-point type.

\subsection{Object detection based on eye tracking}
...
\textbf{References} section; see below). Please note that pages should be numbered. \cite{wolf2018automating}
